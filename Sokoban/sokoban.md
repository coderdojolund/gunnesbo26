...
TODO: Migrate the code block to p5.js. The resulting code should fit into the tutorial flow.
...
✏️ Klipp och klistra in variabeln `levels` med alla nivåerna &ndash; du behöver inte mata in det för hand. Testkör!
...
# Globala variabler här nedanför
levels = ... # denna hittar du här ovanför
